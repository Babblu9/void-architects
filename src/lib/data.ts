...
export const PROCESS = [
  {
    no: "01",
    title: "Understand",
    text: "Every project begins by listening—to the site, its surroundings, and the aspirations of the people who will experience it.",
  },
  {
    no: "02",
    title: "Explore",
    text: "Through research, conceptual studies, and creative exploration, we investigate possibilities beyond the obvious.",
  },
  {
    no: "03",
    title: "Refine",
    text: "Every proportion, material, and detail is carefully considered to create clarity and coherence.",
  },
  {
    no: "04",
    title: "Realize",
    text: "Working closely with consultants, craftsmen, and project partners, we bring considered designs to life with precision and care.",
  },
];
